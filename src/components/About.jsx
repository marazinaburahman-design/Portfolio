    ...
    >
      <div className="w-full md:w-4/5 mx-auto px-4">
        ...
        <div className="flex justify-center">
          <div className="grid md:grid-cols-2 gap-12 md:gap-50 items-center max-w-6xl w-full">
            ...
            >
              ...
              <p className="text-indigo-700 font-semibold text-lg mt-2">
                Aspiring Full-Stack Developer | MERN Stack
              </p>

              <p className="mt-6 text-slate-600 leading-relaxed text-base md:text-lg">
                I'm a Full-Stack developer based in Kattankudy, Sri Lanka.
                Passionate about building responsive and interactive web
                applications using React.js, Node.js, Express.js, and MongoDB.
                Completed 6-month MERN Stack training at Marazin Academy.
                Skilled in JavaScript, Tailwind CSS, Git, and API integration.
                I love creating real-world web applications and translating
                design requirements into functional solutions.
              </p>
