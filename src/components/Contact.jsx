  ...
  return (
    <section id="contact" className="w-4/5 mx-auto px-6 py-20 text-center overflow-hidden">
      ...
      <MotionReveal direction="scale" delay={0.1} className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
        <motion.a href="rahmannoon12@gmail.com" className="bg-indigo-700 text-white font-semibold px-6 py-3 rounded-full" whileHover={{ y: -5, scale: 1.045 }} whileTap={{ scale: 0.96 }}>✉️ rahmannoon12@gmail.com</motion.a>
        <motion.a href="tel:+919080388310" className="bg-slate-900 text-white font-semibold px-6 py-3 rounded-full" whileHover={{ y: -5, scale: 1.045 }} whileTap={{ scale: 0.96 }}>📞 +94 772 425 826</motion.a>
      </MotionReveal>
    </section>
  )
}
